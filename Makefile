...
test :; forge test --match-path ../test/integrations/BasicNftTest.t.sol -vv
...
verify:
	@forge verify-contract --chain-id 1337 0x5FbDB2315678afecb367f032d93F642f64180aa3 BasicNft.sol:BasicNft
